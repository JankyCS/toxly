    ...
    onImageChange = async event => {
      if (event.target.files && event.target.files[0]) {
        ...
        reader.onloadend = async () => {
          ...
          // var i = await fetch('https://vision.googleapis.com/v1/images:annotate?key=AIzaSyAllqUVs49Qm-X5TCITaDnTs7lcNjv6G2E', requestOptions)
          // .then(response => {
          ...
          // this.setState({word:JSON.stringify(i)})
        }
      }  
    };
