...
function IngredientCard(props) {
    ...
    return (
        //Card 
        /*the conditionals are changing the colors of the cards and the badges
        High Score (4-5): Dark - Red Badge
        Med Score (2-3): Grey - Yellow Badge
        Low Score (1): 1 - Success Badge
        */
